...
<div data-role="panel" id="left-panel" data-display="reveal" data-position="left">
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li><a href="<?= base_url() ?>Gallery" data-transition="slidefade"><img src="<?= base_url() ?>assets/images/icons/black/gallery.png" alt="" title="" /><span>Upload Foto</span></a></li>
    ...
    <div class="user_login_info">
        ...
        <nav class="user-nav">
            <ul>
                ...
                <li><a href="<?= base_url() ?>User/prewed"><img src="<?= base_url() ?>assets/images/icons/white/user.png" alt="" title="" /><span>Upload Foto Pengantin</span></a></li>
